...
#sudo reqired for RVM to install required system deps
RUN echo 'username ALL=(ALL) NOPASSWD: ALL' >> /etc/sudoers
USER dev
ENV HOME /home/dev
RUN cd /home/dev && gpg --keyserver hkp://keys.gnupg.net --recv-keys 409B6B1796C275462A1703113804BB82D39DC0E3 && curl -sSL https://get.rvm.io -o rvm.sh && cat rvm.sh | bash -s -- --ignore-dotfiles
